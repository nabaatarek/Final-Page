	...
	<body>
		<div class="header">
			<div>
				...
				<form action="https://www.google.iq/?gfe_rd=cr&dcr=0&ei=sA3vWaq-G4XIXpfug9gB" class="search">
			...
			<div id="navigation">
				<ul>
					...
					<li class="selected"><a href="Jewelry.php">Jewelry</a></li>
				</ul>
			</div>
		</div> 
		<div class="body">
